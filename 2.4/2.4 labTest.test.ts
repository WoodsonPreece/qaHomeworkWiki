...
// not very certain if i fully understand syntax yet, i've been studying on W3 schools and its starting to make sense.
...
// I understand that await driver.findElement finds the specific element in employee manager.
